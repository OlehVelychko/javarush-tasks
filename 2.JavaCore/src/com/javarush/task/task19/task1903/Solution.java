...
public class Solution {
    ...
    public static class IncomeDataAdapter implements Customer, Contact {
        ...
        public String getPhoneNumber() {
            ...
            String formattedPhoneNumber = String.format("+%d(%s)%s-%s-%s",
                    phoneCode, phoneNumberString.substring(0, 3), phoneNumberString.substring(3, 6),
                    phoneNumberString.substring(6, 8), phoneNumberString.substring(8, 10));
